...
export default function CustomerUpdateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setMobile_number(cleanValues.mobile_number);
    setSubscribed_to_marketing(cleanValues.subscribed_to_marketing);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        let modelFields = {
          ...
          subscribed_to_marketing: subscribed_to_marketing ?? null,
          Rating: Rating ?? null,
        };
